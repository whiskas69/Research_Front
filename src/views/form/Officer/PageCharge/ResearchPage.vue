      ...
      <Mainbox>
        ...
        <div>
          ...
          <SectionWrapper>
            ...
            <div class="flex flex-row ml-5 bg-orange-200">
              <RadioInput
                label="วิจัยพื้นฐาน"
                value="วิจัยพื้นฐาน"
                name="type"
...
const handleInputRediO = (event) => {
  formData.redioAuthOffic = event.target.value || event.target.value;
  console.log("Updated redioAuthOffic:", formData.redioAuthOffic);
  console.log("puch in redioAuthOffic", formData.redioAuthOffic);
